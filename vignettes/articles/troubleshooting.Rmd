...
Note: Backward elimination now evaluates both ΔOFV and RSE. Removals can also be blocked by high RSE.
If RSE is unavailable (NA), that is treated as acceptable.
...
Resuming a search refreshes the last step for you; see
[Understanding the Recovery System](recovery-system.html#resuming-a-search).
