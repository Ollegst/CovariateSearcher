...
write.csv(covariate_config, "data/covariate_search.csv", row.names = FALSE)
```
...
search_state <- initialize_new_search(
  base_model_path = "models/run1",              # Your base model
  data_file_path = "data/nonmem_data.csv",      # NONMEM dataset
...
```{r export}
# Save complete state
saveRDS(search_state, "output/search_state.rds")

# Export database to CSV
write.csv(
  search_state$search_database,
  "output/scm_results.csv",
  row.names = FALSE
)
```
