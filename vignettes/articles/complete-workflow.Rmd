...
Backward elimination keeps/removes covariates using both criteria:

- Removal must satisfy backward ΔOFV criterion (`backward_p_value`)
- Removal must satisfy RSE criterion (`rse_threshold`)
- If RSE is not available (NA), it is accepted
