...
In a new session `ss` is gone - load it back from a checkpoint first. They are
written to `<models_folder>/scm_rds/` as `NN_phase_event.rds`, zero-padded by
step, so the last one alphabetically is the most recent:
